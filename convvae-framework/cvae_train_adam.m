function [net_enc, net_dec, info] = cvae_train_adam(opts, net_enc, net_dec, imdb, getBatch, updateError)
...
for epoch=epoch_start+1:opts.numEpochs
  ...
  for t = 1:opts.batchSize:numel(train)
    ...
    [cost, res_enc, res_dec] = cvae_cost(data, style, noise, net_enc, net_dec, [], []);
    ii = ii + 1;
    % gradient update
